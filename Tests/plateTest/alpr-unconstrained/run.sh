...
lp_model="data/lp-detector/wpod-net_update1.json"
input_dir=''
output_dir=''
csv_file=''
...
# Detect vehicles
python3.10 vehicle-detection.py $input_dir $output_dir

# Detect license plates
python3.10 lpr-detec.py $output_dir $lp_model

# OCR
python3.10 license-plate-ocr.py $output_dir

# Draw output and generate list
#python3.10 gen-outputs.py $input_dir $output_dir > $csv_file
